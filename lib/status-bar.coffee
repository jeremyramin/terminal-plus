...
class StatusBar extends View
  ...
  initialize: (@statusBarProvider) ->
    ...
    @subscriptions.add atom.commands.add 'atom-workspace',
      ...
      'platformio-ide-terminal:insert-custom-text-3': => @runInActiveView (i) -> i.insertCustom(atom.config.get('platformio-ide-terminal.customTexts.customText3'))
      'platformio-ide-terminal:insert-custom-text-4': => @runInActiveView (i) -> i.insertCustom(atom.config.get('platformio-ide-terminal.customTexts.customText4'))
      'platformio-ide-terminal:insert-custom-text-5': => @runInActiveView (i) -> i.insertCustom(atom.config.get('platformio-ide-terminal.customTexts.customText5'))
      'platformio-ide-terminal:insert-custom-text-6': => @runInActiveView (i) -> i.insertCustom(atom.config.get('platformio-ide-terminal.customTexts.customText6'))
      'platformio-ide-terminal:insert-custom-text-7': => @runInActiveView (i) -> i.insertCustom(atom.config.get('platformio-ide-terminal.customTexts.customText7'))
      'platformio-ide-terminal:insert-custom-text-8': => @runInActiveView (i) -> i.insertCustom(atom.config.get('platformio-ide-terminal.customTexts.customText8'))
